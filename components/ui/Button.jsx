...
export default function Button({ children, href, type = "primary", className = "" }) {
  ...
  const typeStyles = {
    ...
    secondary: "bg-secondary text-white hover:bg-secondary/90 shadow-prominent",
    outline: "bg-transparent text-secondary border-2 border-secondary hover:bg-secondary hover:text-white",
